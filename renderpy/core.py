...
# opengl
from renderpy.opengl_wrapper import GL
from renderpy.opengl_wrapper import vbo
...
class Renderpy:
    ...
    def compile_shaders(self):
        ...
        # compile the shaders
        textured_shader_data['vertex_shader'] = GL.shaders.compileShader(
                shader_definitions.textured_vertex_shader, GL.GL_VERTEX_SHADER)
        textured_shader_data['fragment_shader'] = GL.shaders.compileShader(
                shader_definitions.textured_fragment_shader, GL.GL_FRAGMENT_SHADER)
        vertex_color_shader_data['vertex_shader'] = GL.shaders.compileShader(
                shader_definitions.vertex_color_vertex_shader, GL.GL_VERTEX_SHADER)
        vertex_color_shader_data['fragment_shader'] = GL.shaders.compileShader(
                shader_definitions.vertex_color_fragment_shader,
                GL.GL_FRAGMENT_SHADER)
        mask_shader_data['vertex_shader'] = GL.shaders.compileShader(
                shader_definitions.mask_vertex_shader, GL.GL_VERTEX_SHADER)
        mask_shader_data['fragment_shader'] = GL.shaders.compileShader(
                shader_definitions.mask_fragment_shader, GL.GL_FRAGMENT_SHADER)
        coord_shader_data['vertex_shader'] = GL.shaders.compileShader(
                shader_definitions.coord_vertex_shader, GL.GL_VERTEX_SHADER)
        coord_shader_data['fragment_shader'] = GL.shaders.compileShader(
                shader_definitions.coord_fragment_shader, GL.GL_FRAGMENT_SHADER)
        background_shader_data['vertex_shader'] = GL.shaders.compileShader(
                shader_definitions.background_vertex_shader, GL.GL_VERTEX_SHADER)
        background_shader_data['fragment_shader'] = GL.shaders.compileShader(
                shader_definitions.background_fragment_shader,
                GL.GL_FRAGMENT_SHADER)
        textured_depthmap_shader_data['vertex_shader'] = GL.shaders.compileShader(
        ...
        textured_depthmap_program = GL.shaders.compileProgram(
        ...
        for variable in (
                ...
                'reflect_sampler'):
            textured_shader_data['locations'][variable] = (
                    GL.glGetUniformLocation(textured_program, variable))
            vertex_color_shader_data['locations'][variable] = (
                    GL.glGetUniformLocation(vertex_color_program, variable))

        # (sampler data)
        textured_shader_data['locations']['texture_sampler'] = (
            GL.glGetUniformLocation(textured_program, 'texture_sampler'))
        background_shader_data['locations']['cubemap_sampler'] = (
                GL.glGetUniformLocation(background_program, 'cubemap_sampler'))
        textured_depthmap_shader_data['locations']['texture_sampler'] = (
                GL.glGetUniformLocation(
                    textured_depthmap_program, 'texture_sampler'))

        GL.glUseProgram(textured_program)
        GL.glUniform1i(textured_shader_data['locations']['texture_sampler'], 0)
        GL.glUniform1i(textured_shader_data['locations']['diffuse_sampler'], 2)
        GL.glUniform1i(textured_shader_data['locations']['reflect_sampler'], 3)

        GL.glUseProgram(vertex_color_program)
        GL.glUniform1i(vertex_color_shader_data['locations']['diffuse_sampler'], 2)
        GL.glUniform1i(vertex_color_shader_data['locations']['reflect_sampler'], 3)

        GL.glUseProgram(background_program)
        GL.glUniform1i(background_shader_data['locations']['cubemap_sampler'], 0)

        GL.glUseProgram(textured_depthmap_program)
        GL.glUniform1i(
                textured_depthmap_shader_data['locations']['texture_sampler'],
                0)
        ...
        mask_shader_data['locations']['mask_color'] = (
                GL.glGetUniformLocation(mask_program, 'mask_color'))

        # (coord_data)
        coord_shader_data['locations']['box_min'] = (
                GL.glGetUniformLocation(coord_program, 'box_min'))
        coord_shader_data['locations']['box_max'] = (
                GL.glGetUniformLocation(coord_program, 'box_max'))

        # (textured depthmap data)
        textured_depthmap_shader_data['locations']['focal_length'] = (
                GL.glGetUniformLocation(textured_depthmap_program, 'focal_length'))
        textured_depthmap_shader_data['locations']['width'] = (
                GL.glGetUniformLocation(textured_depthmap_program, 'width'))
        textured_depthmap_shader_data['locations']['height'] = (
                GL.glGetUniformLocation(textured_depthmap_program, 'height'))
    ...
    def color_render(self,
        ...
        GL.glUseProgram(self.gl_data['textured_depthmap_shader']['program'])
        try:
            location_data = (
    ...
    def render_background(self, image_light_name, flip_y=True):
        GL.glUseProgram(self.gl_data['background_shader']['program'])
    ...
    def mask_render(self, instances=None, flip_y=True):
        ...
        # turn on the shader
        GL.glUseProgram(self.gl_data['mask_shader']['program'])
    ...
    def coord_render(self, instances=None, flip_y=True):
        ...
        # turn on the shader
        GL.glUseProgram(self.gl_data['coord_shader']['program'])
