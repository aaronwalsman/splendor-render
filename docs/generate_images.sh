...
splendor_render examples/02_primitives \
     "$IMGDIR/02_primitives.png" --resolution 768x512

# 03 — shadows
splendor_render examples/03_shadows \
     "$IMGDIR/03_shadows.png" --resolution 512x512

# 04 — debug overlays
splendor_render examples/04_debug_overlays \
     "$IMGDIR/04_debug_overlays.png" --resolution 768x512

# 05 — materials
splendor_render examples/05_materials \
     "$IMGDIR/05_materials.png" --resolution 768x512

# 06 — radial distortion
splendor_render examples/06_radial_distortion \
     "$IMGDIR/06_radial_distortion.png" --resolution 512x512
...
splendor_render examples/08_multi_light \
     "$IMGDIR/08_multi_light.png" --resolution 768x512
